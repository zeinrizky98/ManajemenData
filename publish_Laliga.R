...
library(dplyr)
library(rvest)
urlPT <- "https://www.goal.com/id/laliga/tabel/34pl8szyvrbwcmfkuocjm3r6t"
...
p = formattable(data3[[2]], list(
  "Pos" = color_tile("pink", "white"),
  "+/-" = formatter("span",
...
status_details <- paste0(Sys.Date(),": Top 3 Kelasemen Sementara Liga Spanyol Musim 2021-2022 :", "\n",
                         "1. ",    data3[[2]][1,2],"\n", 
                         "2. ",    data3[[2]][2,2],"\n",
                         "3. ",    data3[[2]][3,2],"\n",
