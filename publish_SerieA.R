...
library(dplyr)
library(rvest)
urlPT <- "https://www.goal.com/id/serie-a/tabel/1r097lpxe0xn03ihb7wi98kao"
data2 <- urlPT %>% read_html() %>% html_table()
...
status_details <- paste0(Sys.Date(),": Top 3 Kelasemen Sementara Liga Italia Musim 2021-2022 :", "\n",
                         "1. ",    data2[[2]][1,2],"\n", 
                         "2. ",    data2[[2]][2,2],"\n",
                         "3. ",    data2[[2]][3,2],"\n",
